...
public class MapServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, TouristPlace> placeMap = mapOperations.add(place);
			
		if(add!=null) {
			// call the add method and store the return value in a map variable
			
			request.setAttribute("bucketList", placeMap);
		...
		if(sortRandom!=null) {
			...
			request.setAttribute("bucketList", mapOperations.sortRandomly(placeMap));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		...
		if(sortInEntryOrder!=null) {
			...
			request.setAttribute("bucketList", mapOperations.sortInEntryOrder(placeMap));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		if(sortAlphabetically!=null) {
			...
			request.setAttribute("bucketList", mapOperations.sortAlphabetically(placeMap));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		...
		if(reset!=null) {	
			...
			request.setAttribute("bucketList", mapOperations.reset(placeMap));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
